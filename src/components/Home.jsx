  ...
  let projects = [
    {
      ...
      tech: "MERN - MongoDB (Mongoose), Express, React, Node, AuthO, HTML/CSS, Bootstrap",
      ...
      tech: "MERN stack (MongoDB, Express, React, Node), HTML/CSS, Bootstrap, Infermedica API",
      ...
      tech: "React, Materialize, Trivia API",
