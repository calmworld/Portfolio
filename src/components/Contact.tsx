      ...
      <nav>
        <ul>
          ...
          <li data-alt="github">
            ...
            <a href="https://github.com/calmworld" target="_blank" rel="noopener noreferrer">
              calmworld
            </a>
          </li>
          <li>
            <InboxIcon />
            <div className="spacer"></div>
            <a href="https://drive.google.com/file/d/1tZQiNuToytZO8yN1aDKmCKdyZEDHhg4B/view?usp=sharing" target="_blank" rel="noopener noreferrer">
              Resume
            </a>
          </li>
        </ul>
